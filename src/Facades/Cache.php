...
/**
 * @method static ICache store(?string $name = null)
 * @method static bool has(string $key)
 * @method static bool missing(string $key)
 * @method static mixed get(string $key)
 * @method static array many(array $keys)
 * @method static bool add(string $key, array|string|int|float|bool|null $value, ?int $ttl = null)
 * @method static bool set(string $key, array|string|int|float|bool|null $value, ?int $ttl = null)
 * @method static bool put(string $key, array|string|int|float|bool|null $value, ?int $ttl = null)
 ...
 * @method static bool forever(string $key, array|string|int|float|bool|null $value)
