...
use Closure;
use Imhotep\Database\Mysql\SchemaGrammar;
...
class MysqlSchemaGrammarTest extends TestCase
{
    ...
    protected function getGrammar(): SchemaGrammar
    {
    ...
    protected function getStatements(Closure $callback): array
    {
    ...
    public function test_create_table()
    {
        ...
        $this->assertCount(1, $statements);
        $this->assertSame('CREATE TEMPORARY TABLE `test` (`id` bigint unsigned AUTO_INCREMENT PRIMARY KEY, `text` text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci', $statements[0]);
    }
    ...
    public function test_datetime_data_types_columns()
    {
        ...
        $this->assertCount(1, $statements);
        $this->assertSame('ALTER TABLE `test` ADD `deleted_at` timestamp', $statements[0]);
    }
